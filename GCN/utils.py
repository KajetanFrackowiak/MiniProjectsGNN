...
def plot_training_stats(train_stats, dataset_name, datetime_now, output_dir):
    ...
    plt.savefig(os.path.join(output_dir, f'training_validation_loss_{dataset_name}_{datetime_now}.png'))
    plt.close()
...
def save_metadata(model, config, seed, datetime_now, filepath):
